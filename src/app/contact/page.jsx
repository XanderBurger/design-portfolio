...
export default function Contact() {
  return (
    <div className="grid h-screen w-full items-center justify-center">
        <div>
        <h1 className="text-[52px] lg:text-[72px] sm:text-[52px] font-[500] italic text-center">Send me an <a href="mailto: xanderbdesign@gmail.com" className="underline hover:text-hot-pink">email</a></h1>
