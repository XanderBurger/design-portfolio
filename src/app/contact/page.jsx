  ...
  return (
    <>
      ...
      <div className="grid h-screen w-full items-center justify-center cursor-none">
        <div>
          <h1 className="text-[52px] lg:text-[72px] sm:text-[52px] font-[500] italic text-center md:leading-[72px] leading-[52px]">
            Send me an{" "}
            <a
          ...
          <div className="flex space-x-[10px] justify-center md:justify-start pt-2">
            <a
              className="text-hot-pink underline hover:text-black"
